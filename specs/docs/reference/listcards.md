...
**Note:&#x20;**&#x4C;ist cards does not return sensitive card information such as PAN and CVC. These can be returned using the <Anchor target="_blank" href="https://docs.mercury.com/update/reference/vault">Vault API</Anchor>'s <Anchor target="_blank" href="https://docs.mercury.com/update/reference/revealcardpan">/revealcardpan endpoint</Anchor> for Agent cards only.
