---
updatedAt: 2026-06-22T18:02:19.000Z
---
...
**Freeze a card.** Temporarily pause authorizations and resume them later. Useful when a card is misplaced or when you want to halt usage without permanently closing the card.
...
```json
{
  ...
  "paths": {
    "/cards/{cardId}/freeze": {
      "post": {
        "description": "Temporarily freeze a card. The card must be active.",
